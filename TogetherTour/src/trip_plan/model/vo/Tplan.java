...
public class Tplan {
	...
	public Tplan(String title, String mId, int day, String content, Date createDate, String country, String city,
			Date startDate, Date endDate, String status, int tCount) {
		super();
		this.title = title;
		this.mId = mId;
		this.day = day;
	...
	public Tplan(int tPnum, String title, String mId, int day, String content, Date createDate, String country,
			String city, Date startDate, Date endDate, String status, int kind, int tCount) {
		super();
		this.tPnum = tPnum;
		this.title = title;
		this.mId = mId;
