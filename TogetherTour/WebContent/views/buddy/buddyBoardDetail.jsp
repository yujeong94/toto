...
<body>
	...
	<div class="contents">
		<div class="buddyDetail">
			<form action="<%=request.getContextPath() %>/views/buddy/buddyUpdateForm.jsp" id="detailForm" method="post"></form>
			<h2>동행자 상세조회</h2>
		...
		<div>	
			<input type="button" value="여행중">
			<input type="button"value="여행계획중">
			<br><br>
			...
			<table>
				<tr>
					<th>제목</th>
					<td>
						<input type="text" size="40" name="title" value="<%= b.getTitle() %>">  <!-- <%=b.getTitle() %>  -->
					</td>
				</tr>
				<tr>
					<th>여행기간</th>
					<td>
						<input type="date" size="10"  value="2020-02-21" min="2020-02-21">
						&nbsp; ~ &nbsp;
						<input type="date" size="10"  value="2020-02-21" min="2020-02-21">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<input type="radio" name="radiobutton" value="tour" onClick="this.form.textbox.disabled=true" >관광
